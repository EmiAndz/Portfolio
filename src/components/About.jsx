          ...
          >
            <div className="aspect-[3/4] border border-ink-700 relative overflow-hidden bg-gradient-to-br from-ink-900 to-ink-850 group">
              ...
              <img
                ...
                loading="lazy"
                className="absolute inset-0 w-full h-full object-cover scale-[1.25] translate-y-[4%] origin-top grayscale-[35%] group-hover:grayscale-0 transition-all duration-700"
